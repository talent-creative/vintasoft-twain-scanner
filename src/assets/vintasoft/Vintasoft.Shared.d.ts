...
declare module Vintasoft.Shared {
  ...
  class WebServiceJS {
    ...
    /**
     * Default service for image rendering.
     */
    ...
    /**
     * Default service for working with files.
     */
    static defaultFileService: WebServiceJS;

    /**
     * Default service for processing of images.
     */
    static defaultImageProcessingService: WebServiceJS;

    /**
     * Default service for converting image files.
     */
    static defaultConverterService: WebServiceJS;

    /**
     * Default service for processing of document images.
     */
    static defaultImageProcessingDocCleanupService: WebServiceJS;

    /**
     * Default service for annotating of images.
     */
    static defaultAnnotationService: WebServiceJS;

    /**
     * Default service for working with PDF documents.
     */
    static defaultPdfService: WebServiceJS;

    /**
     * Default service for working with barcodes.
     */
    static defaultBarcodeService: WebServiceJS;

    /**
     * Default service for working with TWAIN device manager.
     */
  ...
  class VintasoftLocalizationJS {
    ...
    /**
     * Localizes all DOM elements, which have the "localizationId" attribute.
     */
